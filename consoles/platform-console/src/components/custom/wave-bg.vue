...
const lightColor = computed(() => `color-mix(in srgb, ${props.themeColor} 30%, white)`);
const darkColor = computed(() => props.themeColor);
</script>

<template>
  <div aria-hidden="true" class="absolute left-0 top-0 z-1 size-full overflow-hidden">
