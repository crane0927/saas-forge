...
test('reports compatibility failures without exposing test titles or assertion payloads', async (t) => {
  ...
  await writeFile(
    ...
    [
      ...
      ' ❯ browser-test/admin.browser.test.ts:52:9',
      ' ❯ test/layout.browser.mjs:28:3',
  ...
  assert.equal(
    ...
    [
      ...
      'AT: consoles/browser-test/admin.browser.test.ts:52:9',
      'AT: consoles/shared/admin/test/layout.browser.mjs:28:3',
