...
> 适用范围：现行 v1 与历史决策。#201/#202 已确认统一登录不预选 Intent；新协议设计见 [ADR 0052](0052-unified-console-authentication-uses-versioned-session-protocol.md)（已确认、未实施）。下文不再作为新版登录目标，v1 实现及历史基线保持原状。
