package io.saas.forge.sdk.core.rest;
...
class JavaSdkGeneratedSurfaceTest {
    ...
    void generatedJavaApiContainsNoBrowserOperationsOrBrowserManagedInputs() throws Exception {
        Class<?> authenticationApi = Class.forName("io.saas.forge.sdk.core.rest.api.AuthenticationApi");
        ...
        assertFalse(classExists("io.saas.forge.sdk.core.rest.model.LoginRequest"));
        assertFalse(classExists("io.saas.forge.sdk.core.rest.model.PasswordSetupRequest"));
        assertFalse(classExists("io.saas.forge.sdk.core.rest.model.SessionSlotRequest"));
    }
