...
public class TenantContextSwitchedEventValidator {
    ...
    public static final String SOURCE = "urn:saas.forge:iam-service";
    public static final String DATASCHEMA =
            "https://saas.forge.io/contracts/events/iam-tenant-context-switched.v1.schema.json";
    ...
    public TenantContextSwitchedEventValidator(
            ...
            @Value("${saas.forge.audit.iam-session-topic}") String expectedTopic) {
        this.objectMapper = objectMapper;
        if (expectedTopic == null
                || !expectedTopic.matches("^saas\\.forge\\.[a-z][a-z0-9-]*\\.iam-service\\.events$")) {
