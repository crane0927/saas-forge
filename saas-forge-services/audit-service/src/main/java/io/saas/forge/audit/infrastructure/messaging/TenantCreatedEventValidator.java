...
public class TenantCreatedEventValidator {
    ...
    public static final String EVENT_TYPE = "com.saas.forge.tenant.created.v1";
    public static final String SOURCE = "urn:saas.forge:tenant-access-service";
    public static final String DATASCHEMA =
            "https://saas.forge.io/contracts/events/tenant-created.v1.schema.json";
    ...
    public TenantCreatedEventValidator(
            ...
            @Value("${saas.forge.audit.tenant-access-topic}") String expectedTopic) {
        this.objectMapper = objectMapper;
        if (expectedTopic == null
                || !expectedTopic.matches("^saas\\.forge\\.[a-z][a-z0-9-]*\\.tenant-access-service\\.events$")) {
