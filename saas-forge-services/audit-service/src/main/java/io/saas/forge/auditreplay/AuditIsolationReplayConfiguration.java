package io.saas.forge.auditreplay;

import io.saas.forge.audit.application.AuditConsumerFailurePolicy;
import io.saas.forge.audit.application.AuditIsolationReplayRepository;
import io.saas.forge.audit.application.AuditIsolationReplayService;
import io.saas.forge.audit.infrastructure.messaging.AuditIsolationReplayPublisher;
...
class AuditIsolationReplayConfiguration {
    ...
    AuditIsolationReplayPublisher auditIsolationReplayPublisher(
            ...
            Clock auditIsolationReplayClock,
            @Value("${saas.forge.audit.replay.lease-duration:PT30S}") Duration leaseDuration) {
    ...
    AuditIsolationReplayRunner auditIsolationReplayRunner(
            ...
            @Value("${saas.forge.audit.replay.isolation-id}") String isolationId) {
