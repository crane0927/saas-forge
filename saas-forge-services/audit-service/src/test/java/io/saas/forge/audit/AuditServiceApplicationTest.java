...
import io.saas.forge.audit.config.NacosRegistrationReadinessHealthIndicator;
...
class AuditServiceApplicationTest {
    ...
    void createsRequiredNacosConfigurationWhenTheMarkerIsProvided() {
        new ApplicationContextRunner()
                ...
                .withPropertyValues("saas.forge.audit.configuration-revision=test")
    ...
    void failsStartupWhenRequiredNacosConfigurationIsUnavailable() {
        assertThrows(RuntimeException.class, () -> new SpringApplicationBuilder(AuditServiceApplication.class)
                .properties(
                        "spring.main.web-application-type=none",
                        "spring.config.import=nacos:audit-service.yaml?group=SAAS_FORGE",
                        "spring.cloud.nacos.config.server-addr=127.0.0.1:1",
                        "spring.cloud.nacos.username=audit-test",
                        "spring.cloud.nacos.password=audit-test-password",
