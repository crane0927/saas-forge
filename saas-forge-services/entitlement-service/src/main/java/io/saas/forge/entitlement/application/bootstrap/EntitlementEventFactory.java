...
import io.saas.forge.entitlement.domain.quota.QuotaOperationAction;
...
public final class EntitlementEventFactory {
    private static final String SOURCE = "urn:saas.forge:entitlement-service";
    ...
    public OutboxEvent quotaDefinition(
        ...
        return event(result.id(), "com.saas.forge.quota-definition." + action + ".v1",
    ...
    public OutboxEvent plan(
        ...
        data.put("actorIdentityId", actorIdentityId.toString());
        String action = activated ? "activated" : "created";
        return event(result.id(), "com.saas.forge.plan." + action + ".v1",
    ...
    public OutboxEvent subscription(
        ...
        data.put("actorIdentityId", actorIdentityId.toString());
        return event(result.id(), "com.saas.forge.subscription.created.v1",
    ...
    public OutboxEvent quotaOperation(
        ...
        return event(tenantId, "com.saas.forge.quota." + eventAction + ".v1",
    ...
    private OutboxEvent event(
        ...
        snapshot.put("dataschema", "https://saas.forge.io/contracts/events/" + schema);
        if (traceId != null) {
