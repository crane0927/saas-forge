...
public class RecoverablePlanService {
    ...
    public PlanResult create(UUID actor, UUID key, PlanDraft draft, String traceId) {
        ...
        io.saas.forge.entitlement.domain.plan.Plan.validateDraftFields(draft.code(), draft.displayName(),
                new io.saas.forge.entitlement.domain.plan.PlanQuotaLimit(draft.quotaDefinitionId(),
