...
import io.saas.forge.entitlement.infrastructure.grpc.GrpcPlatformRoleChecker;
...
import io.saas.forge.entitlement.infrastructure.security.RedisUserAccessTokenRevocationChecker;
import io.saas.forge.entitlement.infrastructure.security.SdkPlatformAdminAuthorizer;
...
public class PlatformAuthorizationConfiguration {
    ...
    IamServiceAccessTokenProvider entitlementIamServiceAccessTokenProvider(
            ...
            Clock clock,
            @Value("${saas.forge.entitlement.service-client-id-file}") String clientIdFile,
            @Value("${saas.forge.entitlement.service-client-secret-file}") String clientSecretFile) {
