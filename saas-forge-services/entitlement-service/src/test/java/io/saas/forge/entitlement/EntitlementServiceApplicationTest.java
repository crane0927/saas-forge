...
import io.saas.forge.entitlement.config.NacosRegistrationReadinessHealthIndicator;
...
class EntitlementServiceApplicationTest {
    ...
    void createsRequiredNacosConfigurationWhenTheMarkerIsProvided() {
        new ApplicationContextRunner()
                ...
                .withPropertyValues("saas.forge.entitlement.configuration-revision=test")
