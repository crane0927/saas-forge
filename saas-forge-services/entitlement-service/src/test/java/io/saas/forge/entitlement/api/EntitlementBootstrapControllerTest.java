...
class EntitlementBootstrapControllerTest {
    ...
    void rejectsNonEmptyOrNonObjectRecoveryBodyBeforeInvokingBusinessOperation() throws Exception {
        var recovery = Mockito.mock(
                io.saas.forge.entitlement.application.bootstrap.RecoverableQuotaDefinitionService.class);
    ...
    private static MockMvc mvc(
        ...
        return MockMvcBuilders.standaloneSetup(
                        new EntitlementBootstrapController(authorizer,
                            new io.saas.forge.entitlement.application.bootstrap.RecoverablePlanService(bootstrap, null, null) {
                                @Override public PlanResult create(UUID actor, UUID key, io.saas.forge.entitlement.application.bootstrap.PlanDraft draft, String trace) {
                            ...
                            }, null, new io.saas.forge.entitlement.application.subscription.RecoverableSubscriptionService(subscriptions, null, null) {
                                @Override public io.saas.forge.entitlement.application.subscription.InitialSubscriptionResult create(
                            ...
                            new io.saas.forge.entitlement.application.bootstrap.RecoverableQuotaDefinitionService(bootstrap, null, null) {
