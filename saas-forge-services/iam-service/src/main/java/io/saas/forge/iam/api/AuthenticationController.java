...
import io.saas.forge.iam.contract.model.CurrentSession;
import io.saas.forge.iam.application.authentication.CurrentSessionQuery;
import io.saas.forge.iam.application.authentication.AccessTokenLoginResult;
import io.saas.forge.iam.application.authentication.CurrentTenantContextQuery;
import io.saas.forge.iam.application.authentication.TenantAuthenticationContextSnapshot;
import io.saas.forge.iam.application.authentication.BrowserSessionSlot;
import io.saas.forge.iam.application.authentication.ContextSelectionLoginResult;
...
import io.saas.forge.iam.application.authentication.InitialPasswordChangeLoginResult;
import io.saas.forge.iam.application.authentication.InitialPasswordChangeService;
import io.saas.forge.iam.application.authentication.LoginContextType;
import io.saas.forge.iam.application.authentication.LoginResult;
...
import io.saas.forge.iam.contract.api.AuthenticationApi;
import io.saas.forge.iam.contract.model.AccessTokenResult;
import io.saas.forge.iam.contract.model.AuthenticationResult;
import io.saas.forge.iam.contract.model.ContextSelectionRequiredResult;
import io.saas.forge.iam.contract.model.ClientCredentialsTokenResponse;
import io.saas.forge.iam.contract.model.ContextSelectionRequest;
import io.saas.forge.iam.contract.model.InitialPasswordChangeRequiredResult;
import io.saas.forge.iam.contract.model.LoginRequest;
import io.saas.forge.iam.contract.model.MembershipCandidate;
import io.saas.forge.iam.contract.model.PasswordChangeRequest;
import io.saas.forge.iam.contract.model.PasswordSetupRequest;
import io.saas.forge.iam.contract.model.SessionSlotRequest;
import io.saas.forge.iam.contract.model.TenantSwitchRequest;
import io.saas.forge.iam.contract.model.TenantAuthenticationContext;
import io.saas.forge.iam.contract.model.TenantBrandProfile;
