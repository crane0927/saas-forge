...
public final class PasswordEstablishedEventFactory {
    public static final String EVENT_TYPE = "com.saas.forge.iam.password.established.v1";
    ...
    public OutboxEvent create(UUID identityId, PasswordCredential credential, Instant occurredAt, String traceId) {
        ...
        snapshot.put("dataschema", "https://saas.forge.io/contracts/events/iam-password-established.v1.schema.json");
        if (traceId != null) {
