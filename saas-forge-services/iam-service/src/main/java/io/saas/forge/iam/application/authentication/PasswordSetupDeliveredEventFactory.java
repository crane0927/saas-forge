...
public final class PasswordSetupDeliveredEventFactory {
    public static final String EVENT_TYPE = "com.saas.forge.iam.password-setup-delivered.v1";
    ...
    public OutboxEvent create(
        ...
        snapshot.put("dataschema", "https://saas.forge.io/contracts/events/iam-password-setup-delivered.v1.schema.json");
        if (traceId != null) {
