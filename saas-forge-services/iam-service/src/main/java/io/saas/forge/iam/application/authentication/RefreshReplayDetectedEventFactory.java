...
public final class RefreshReplayDetectedEventFactory {
    public static final String EVENT_TYPE = "com.saas.forge.iam.refresh-replay-detected.v1";
    ...
    public OutboxEvent create(RefreshTokenFamily family, int revokedAccessTokenCount, Instant at, String traceId) {
        ...
        snapshot.put("dataschema", "https://saas.forge.io/contracts/events/iam-refresh-replay-detected.v1.schema.json");
        if (traceId != null) {
