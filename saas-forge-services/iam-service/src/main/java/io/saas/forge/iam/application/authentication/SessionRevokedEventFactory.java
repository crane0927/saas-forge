...
public final class SessionRevokedEventFactory {
    public static final String EVENT_TYPE = "com.saas.forge.iam.session.revoked.v1";
    ...
    public OutboxEvent create(RefreshTokenFamily family, boolean accessTokenRevoked, Instant occurredAt, String traceId) {
        ...
        snapshot.put("dataschema", "https://saas.forge.io/contracts/events/iam-session-revoked.v1.schema.json");
        if (traceId != null) {
    ...
    public OutboxEvent createForRefreshReplay(
            RefreshTokenFamily family, boolean accessTokenRevoked, Instant occurredAt, String traceId) {
        return create(family, accessTokenRevoked, occurredAt, traceId);
    }
}
