...
public final class SessionStartedEventFactory {
    public static final String EVENT_TYPE = "com.saas.forge.iam.session.started.v1";
    ...
    public OutboxEvent create(RefreshTokenFamily family, Instant occurredAt, String traceId) {
        ...
        snapshot.put("dataschema", "https://saas.forge.io/contracts/events/iam-session-started.v1.schema.json");
        if (traceId != null) {
