...
public final class TenantContextSwitchedEventFactory {
    public static final String EVENT_TYPE = "com.saas.forge.iam.tenant-context-switched.v1";
    ...
    public OutboxEvent create(
        ...
        snapshot.put("dataschema", "https://saas.forge.io/contracts/events/iam-tenant-context-switched.v1.schema.json");
        if (traceId != null) {
