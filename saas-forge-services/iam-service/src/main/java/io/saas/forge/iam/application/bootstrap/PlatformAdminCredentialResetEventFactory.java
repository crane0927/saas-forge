...
public final class PlatformAdminCredentialResetEventFactory {
    public static final String EVENT_TYPE = "com.saas.forge.iam.platform-admin-initial-credential-reset.v1";
    ...
    public OutboxEvent create(
        ...
        snapshot.put("dataschema",
                "https://saas.forge.io/contracts/events/iam-platform-admin-initial-credential-reset.v1.schema.json");
