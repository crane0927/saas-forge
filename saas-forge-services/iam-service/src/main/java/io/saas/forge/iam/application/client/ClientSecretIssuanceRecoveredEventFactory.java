...
public final class ClientSecretIssuanceRecoveredEventFactory {
    public static final String EVENT_TYPE = "com.saas.forge.iam.client-secret.issuance-recovered.v1";
    ...
    public OutboxEvent create(
        ...
        snapshot.put("dataschema",
                "https://saas.forge.io/contracts/events/iam-client-secret-issuance-recovered.v1.schema.json");
