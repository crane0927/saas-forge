...
public final class ClientSecretRotatedEventFactory {
    public static final String EVENT_TYPE = "com.saas.forge.iam.client-secret.rotated.v1";
    ...
    public ClientSecretRotatedEventFactory(
    ...
    public OutboxEvent create(
        ...
        data.put("result", "CLIENT_SECRET_ROTATED");
        ...
        snapshot.put("dataschema", "https://saas.forge.io/contracts/events/iam-client-secret-rotated.v1.schema.json");
