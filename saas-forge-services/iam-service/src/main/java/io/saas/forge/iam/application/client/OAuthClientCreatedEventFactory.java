...
public final class OAuthClientCreatedEventFactory {
    public static final String EVENT_TYPE = "com.saas.forge.iam.oauth-client.created.v1";
    ...
    public OAuthClientCreatedEventFactory(
    ...
    public OutboxEvent create(
        ...
        snapshot.put("dataschema", "https://saas.forge.io/contracts/events/iam-oauth-client-created.v1.schema.json");
