...
import io.saas.forge.contracts.iam.identity.v1.EnsureIdentityResponse;
...
import io.saas.forge.iam.application.identity.EnsureIdentityRequestConflictException;
import io.saas.forge.iam.application.identity.EnsureIdentityResult;
...
public final class IdentityProvisioningGrpcService
    ...
    private static IdentityCredentialStatus credentialStatus(
            io.saas.forge.iam.domain.identity.IdentityCredentialStatus status) {
