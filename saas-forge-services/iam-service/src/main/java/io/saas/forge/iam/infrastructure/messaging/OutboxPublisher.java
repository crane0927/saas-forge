package io.saas.forge.iam.infrastructure.messaging;
...
public class OutboxPublisher {
    ...
    public OutboxPublisher(
            ...
            Clock clock,
            @Value("${saas.forge.iam.outbox.lease-duration:PT30S}") Duration leaseDuration) {
    ...
    @Scheduled(fixedDelayString = "${saas.forge.iam.outbox.publish-delay:PT1S}")
