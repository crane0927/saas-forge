...
public interface OAuthClientMapper {
    ...
    List<io.saas.forge.iam.infrastructure.persistence.record.OAuthClientOperationProjection> listOperations(OperationQuery query);
    io.saas.forge.iam.infrastructure.persistence.record.OAuthClientCredentialProjection credentialStatus(
