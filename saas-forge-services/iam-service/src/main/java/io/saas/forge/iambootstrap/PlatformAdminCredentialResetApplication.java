...
import io.saas.forge.iam.infrastructure.persistence.MyBatisOutboxEventRepository;
import io.saas.forge.iam.infrastructure.persistence.MyBatisPlatformAdminBootstrapRepository;
import io.saas.forge.iam.infrastructure.persistence.MyBatisPlatformAdminCredentialResetRepository;
import io.saas.forge.iam.infrastructure.persistence.MyBatisRefreshTokenFamilyRepository;
...
@MapperScan("io.saas.forge.iam.infrastructure.persistence.mapper")
