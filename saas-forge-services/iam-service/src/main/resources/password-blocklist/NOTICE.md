...
python3 scripts/build-password-blocklist.py \
  ...
  --repository-list saas-forge-services/iam-service/src/main/password-blocklist/saas-forge-passwords.txt \
  --output-directory saas-forge-services/iam-service/src/main/resources/password-blocklist
```
