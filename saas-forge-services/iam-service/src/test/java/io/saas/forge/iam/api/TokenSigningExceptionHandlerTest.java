...
import io.saas.forge.iam.application.signing.TokenSigningUnavailableException;
...
class TokenSigningExceptionHandlerTest {
    ...
    void mapsSigningFailureToTheStable503ProblemContract() {
        ...
        assertEquals("urn:saas.forge:problem:token-signing-unavailable", response.getBody().type().toString());
