...
public class AccessibleMembershipGrpcService
    ...
    public void listAccessibleMemberships(
        ...
        memberships.findByIdentityId(identityId).forEach(membership -> {
            var result = io.saas.forge.contracts.tenantaccess.membership.v1.AccessibleMembership.newBuilder()
            ...
            if (membership.brandProfile() != null) {
                ...
                var profile = io.saas.forge.contracts.tenantaccess.membership.v1.TenantBrandProfile.newBuilder()
