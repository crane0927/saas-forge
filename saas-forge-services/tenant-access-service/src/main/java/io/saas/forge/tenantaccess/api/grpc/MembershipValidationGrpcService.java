...
import io.saas.forge.contracts.tenantaccess.membership.v1.MembershipNotUsable;
        ...
        ValidateMembershipResponse response = memberships.findUsable(identityId, membershipId)
                .map(validated -> ValidateMembershipResponse.newBuilder()
                        .setValidatedMembership(
                                io.saas.forge.contracts.tenantaccess.membership.v1.ValidatedMembership.newBuilder()
