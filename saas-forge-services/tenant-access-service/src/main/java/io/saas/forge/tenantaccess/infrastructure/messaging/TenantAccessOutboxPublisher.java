package io.saas.forge.tenantaccess.infrastructure.messaging;
...
public final class TenantAccessOutboxPublisher {
    ...
    public TenantAccessOutboxPublisher(
            ...
            Clock clock,
            @Value("${saas.forge.tenant-access.outbox.lease-duration:PT30S}") Duration leaseDuration) {
    ...
    @Scheduled(fixedDelayString = "${saas.forge.tenant-access.outbox.publish-delay:PT1S}")
