...
import io.saas.forge.tenantaccess.config.NacosRegistrationReadinessHealthIndicator;
...
class TenantAccessServiceApplicationTest {
    ...
    void createsRequiredNacosConfigurationWhenTheMarkerIsProvided() {
        new ApplicationContextRunner()
                ...
                .withPropertyValues("saas.forge.tenant-access.configuration-revision=test")
