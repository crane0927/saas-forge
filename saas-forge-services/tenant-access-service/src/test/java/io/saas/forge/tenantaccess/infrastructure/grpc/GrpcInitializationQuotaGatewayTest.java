...
import io.saas.forge.tenantaccess.application.administrator.QuotaUnavailableException;
...
class GrpcInitializationQuotaGatewayTest {
    ...
    void sendsConsumeAndReleaseCommandsWithStableQuotaIdentity() {
        ...
        var request = QuotaCommandRequest.newBuilder()
                ...
                .setPurpose(io.saas.forge.contracts.entitlement.quota.v1.QuotaPurpose.TENANT_ADMIN_INITIALIZATION)
                .build();
