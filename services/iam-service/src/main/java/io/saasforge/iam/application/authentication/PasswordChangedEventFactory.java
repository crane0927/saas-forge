...
public final class PasswordChangedEventFactory {
    public static final String EVENT_TYPE = "com.saasforge.iam.password.changed.v1";
    ...
    public OutboxEvent create(
        ...
        snapshot.put("dataschema", "https://saasforge.io/contracts/events/iam-password-changed.v1.schema.json");
        if (traceId != null) {
