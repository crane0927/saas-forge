...
public final class PlatformAdminInitializedEventFactory {
    public static final String EVENT_TYPE = "com.saasforge.iam.platform-admin-initialized.v1";
    ...
    public OutboxEvent create(
        ...
        snapshot.put("dataschema", "https://saasforge.io/contracts/events/iam-platform-admin-initialized.v1.schema.json");
