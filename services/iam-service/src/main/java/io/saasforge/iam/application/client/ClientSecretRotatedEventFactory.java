...
public final class ClientSecretRotatedEventFactory {
    public static final String EVENT_TYPE = "com.saasforge.iam.client-secret.rotated.v1";
    ...
    public OutboxEvent create(
        ...
        snapshot.put("dataschema", "https://saasforge.io/contracts/events/iam-client-secret-rotated.v1.schema.json");
