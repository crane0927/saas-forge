...
public final class OAuthClientRevokedEventFactory {
    public static final String EVENT_TYPE = "com.saasforge.iam.oauth-client.revoked.v1";
    ...
    public OutboxEvent create(
        ...
        snapshot.put("dataschema", "https://saasforge.io/contracts/events/iam-oauth-client-revoked.v1.schema.json");
